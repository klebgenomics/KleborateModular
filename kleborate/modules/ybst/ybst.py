...
def get_results(assembly, args, previous_results):
    ...
    st, lineage, alleles = multi_mlst(assembly, profiles, alleles, genes, 'lineage_ICE',
                                      args.ybst_min_identity, args.ybst_min_coverage,
                                      args.ybst_required_exact_matches)
