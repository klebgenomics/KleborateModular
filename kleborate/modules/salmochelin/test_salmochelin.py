...
def test_check_cli_options_1():
    Args = collections.namedtuple('Args', ['salmochelin_min_identity', 'salmochelin_min_coverage',
                                           'salmochelin_required_exact_matches'])
    check_cli_options(Args(salmochelin_min_identity=90.0, salmochelin_min_coverage=90.0,
                           salmochelin_required_exact_matches=3))
...
def test_check_cli_options_2():
    ...
    with pytest.raises(SystemExit):
        check_cli_options(Args(salmochelin_min_identity=0.90, salmochelin_min_coverage=90.0,
                               salmochelin_required_exact_matches=3))
...
def test_check_cli_options_3():
    Args = collections.namedtuple('Args', ['salmochelin_min_identity', 'salmochelin_min_coverage',
                                           'salmochelin_required_exact_matches'])
    with pytest.raises(SystemExit):
        check_cli_options(Args(salmochelin_min_identity=-90.0, salmochelin_min_coverage=0.90,
                               salmochelin_required_exact_matches=3))
...
def test_check_cli_options_4():
    Args = collections.namedtuple('Args', ['salmochelin_min_identity', 'salmochelin_min_coverage',
                                           'salmochelin_required_exact_matches'])
    with pytest.raises(SystemExit):
        check_cli_options(Args(salmochelin_min_identity=-10.0, salmochelin_min_coverage=90.0,
                               salmochelin_required_exact_matches=3))
...
def test_check_cli_options_5():
    Args = collections.namedtuple('Args', ['salmochelin_min_identity', 'salmochelin_min_coverage',
                                           'salmochelin_required_exact_matches'])
    with pytest.raises(SystemExit):
        check_cli_options(Args(salmochelin_min_identity=90.0, salmochelin_min_coverage=120.0,
                               salmochelin_required_exact_matches=3))
...
def test_check_cli_options_6():
    ...
    with pytest.raises(SystemExit):
        check_cli_options(Args(salmochelin_min_identity=90.0, salmochelin_min_coverage=90.0,
                               salmochelin_required_exact_matches=-2))
...
def test_get_results_1():
    ...
    results = get_results(get_test_genome_dir() / 'GCF_000968155.1.fna.gz',
                          Args(salmochelin_min_identity=90.0, salmochelin_min_coverage=80.0,
                               salmochelin_required_exact_matches=3))
