...
def test_check_cli_options_1():
    Args = collections.namedtuple('Args', ['ybst_min_identity', 'ybst_min_coverage',
                                           'ybst_required_exact_matches'])
    check_cli_options(Args(ybst_min_identity=90.0, ybst_min_coverage=90.0,
...
def test_check_cli_options_2():
    ...
    with pytest.raises(SystemExit):
        check_cli_options(Args(ybst_min_identity=0.90, ybst_min_coverage=90.0,
                               ybst_required_exact_matches=3))
...
def test_check_cli_options_3():
    Args = collections.namedtuple('Args', ['ybst_min_identity', 'ybst_min_coverage',
                                           'ybst_required_exact_matches'])
    with pytest.raises(SystemExit):
        check_cli_options(Args(ybst_min_identity=-90.0, ybst_min_coverage=0.90,
                               ybst_required_exact_matches=3))
...
def test_check_cli_options_4():
    Args = collections.namedtuple('Args', ['ybst_min_identity', 'ybst_min_coverage',
                                           'ybst_required_exact_matches'])
    with pytest.raises(SystemExit):
        check_cli_options(Args(ybst_min_identity=-10.0, ybst_min_coverage=90.0,
                               ybst_required_exact_matches=3))
...
def test_check_cli_options_5():
    Args = collections.namedtuple('Args', ['ybst_min_identity', 'ybst_min_coverage',
                                           'ybst_required_exact_matches'])
    with pytest.raises(SystemExit):
        check_cli_options(Args(ybst_min_identity=90.0, ybst_min_coverage=120.0,
                               ybst_required_exact_matches=3))
