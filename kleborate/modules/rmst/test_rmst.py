...
def test_check_cli_options_1():
    ...
    check_cli_options(Args(rmst_min_identity=90.0, rmst_min_coverage=90.0,
...
def test_check_cli_options_2():
    ...
    with pytest.raises(SystemExit):
        check_cli_options(Args(rmst_min_identity=0.90, rmst_min_coverage=90.0,
                               rmst_required_exact_matches=3))
...
def test_check_cli_options_3():
    Args = collections.namedtuple('Args', ['rmst_min_identity', 'rmst_min_coverage',
                                           'rmst_required_exact_matches'])
    with pytest.raises(SystemExit):
        check_cli_options(Args(rmst_min_identity=-90.0, rmst_min_coverage=0.90,
                               rmst_required_exact_matches=3))
...
def test_check_cli_options_4():
    Args = collections.namedtuple('Args', ['rmst_min_identity', 'rmst_min_coverage',
                                           'rmst_required_exact_matches'])
    with pytest.raises(SystemExit):
        check_cli_options(Args(rmst_min_identity=-10.0, rmst_min_coverage=90.0,
                               rmst_required_exact_matches=3))
...
def test_check_cli_options_5():
    Args = collections.namedtuple('Args', ['rmst_min_identity', 'rmst_min_coverage',
                                           'rmst_required_exact_matches'])
    with pytest.raises(SystemExit):
        check_cli_options(Args(rmst_min_identity=90.0, rmst_min_coverage=120.0,
                               rmst_required_exact_matches=3))
